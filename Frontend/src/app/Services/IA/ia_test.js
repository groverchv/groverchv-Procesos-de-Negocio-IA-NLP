...
var IaService = function () {
    ...
    var IaService = _classThis = /** @class */ (function () {
        function IaService_1(http) {
            this.http = http;
            this.GROQ_API_URL = 'https://api.groq.com/openai/v1/chat/completions';
        }
        Object.defineProperty(IaService_1.prototype, "API_KEY", {
            get: function () {
                try {
        ...
        Object.defineProperty(IaService_1.prototype, "hasValidApiKey", {
            get: function () {
        ...
        IaService_1.prototype.processCommand = function (userMessage, currentNodes, currentEdges) {
            var _this = this;
            ...
            return this.http.post(this.GROQ_API_URL, body, { headers: headers }).pipe((0, operators_1.map)(function (response) {
                var _a, _b;
                ...
                return (0, rxjs_1.throwError)(function () { return new Error('Error communicating with AI: ' + (err.message || 'Unknown error')); });
            }));
        };
        IaService_1.prototype.normalizeIaResponse = function (raw, userMessage, currentNodes) {
            var _a;
        ...
        IaService_1.prototype.enforceSingleAction = function (message, commands) {
            // Permitir operaciones en lote sin truncar
            return commands;
        };
        IaService_1.prototype.parseLaneReference = function (message) {
            if (!message)
                return null;
        ...
        IaService_1.prototype.resolveLaneFromReference = function (reference, nodes) {
            var matches = this.findLaneMatches(reference, nodes);
            return matches.length > 0 ? matches[0] : null;
        };
        IaService_1.prototype.getNextNodeYInLane = function (lane, nodes) {
            var laneX = lane.x || 0;
        ...
        IaService_1.prototype.mapOperationsToCommands = function (operations) {
            var mapped = [];
        ...
        IaService_1.prototype.mapOperationToCommand = function (op) {
            var _a, _b, _c;
        ...
        IaService_1.prototype.normalizeCommand = function (cmd, nextLaneX, currentNodes) {
        ...
        IaService_1.prototype.getNextLaneX = function (nodes) {
        ...
        IaService_1.prototype.getNextLaneName = function (nodes) {
        ...
        IaService_1.prototype.resolveLatestIntent = function (message) {
            var _a;
            if (!message)
                return '';
        ...
        IaService_1.prototype.requiresConfirmation = function (message) {
            return IaService.IMPROVEMENT_WORDS.test(message);
        };
        IaService_1.prototype.isConfirmed = function (message) {
            return IaService.CONFIRM_WORDS.test(message);
        };
        IaService_1.prototype.localFallback = function (userMessage, currentNodes) {
        ...
        IaService_1.prototype.canonicalizeText = function (message) {
        ...
        IaService_1.prototype.splitIntoSteps = function (message) {
            return (message || '')
                .split(/\s*(?:,|;|\by\b|\bluego\b|\bdespués\b|\bentonces\b|\by\s+luego\b)\s*/i)
                .map(function (s) { return s.trim(); })
                .filter(Boolean);
        };
        IaService_1.prototype.tryParseAddNode = function (step, currentNodes) {
            var _this = this;
        ...
        IaService_1.prototype.extractFallbackLabel = function (step, stopWords) {
        ...
        IaService_1.prototype.capitalize = function (s) {
            if (!s)
                return s;
            return s.charAt(0).toUpperCase() + s.slice(1);
        };
        IaService_1.prototype.detectNodeType = function (step) {
        ...
        IaService_1.prototype.tryParseGeneralUpdate = function (step, nodes) {
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.extractLabel = function (step, keywords) {
        ...
        IaService_1.prototype.defaultLabelForNode = function (nodeType) {
            var map = {
                activity: 'Actividad',
                decision: 'Condición',
        ...
        IaService_1.prototype.tryParseMoveNode = function (step, currentNodes) {
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.tryParseStyle = function (step, currentNodes) {
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.tryParseDeleteNodesInLane = function (step, currentNodes) {
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.tryParseDeleteNode = function (step, currentNodes) {
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.tryParseDeleteEdge = function (step, nodes) {
            var _this = this;
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.buildMissingLaneQuestion = function (step, currentNodes) {
            var laneRef = this.parseLaneReference(step);
            if (!laneRef)
                return null;
            var lane = this.resolveLaneFromReference(laneRef, currentNodes);
        ...
        IaService_1.prototype.buildMissingNodeQuestion = function (step, currentNodes) {
            var s = step.toLowerCase();
        ...
        IaService_1.prototype.tryParseRename = function (step, currentNodes) {
            var s = this.normalizeForSearch(step);
        ...
        IaService_1.prototype.extractRenameParts = function (step) {
        ...
        IaService_1.prototype.isConnectIntent = function (text) {
        ...
        IaService_1.prototype.normalizeForSearch = function (value) {
            return (value || '')
                .normalize('NFD')
        ...
        IaService_1.prototype.resolveNodeLabelFromReference = function (ref, nodes) {
            var matches = this.findNodeMatches(ref, nodes);
            return matches.length > 0 ? (matches[0].label || null) : null;
        };
        IaService_1.prototype.findLaneMatches = function (reference, nodes) {
            var _this = this;
            var lanes = nodes
        ...
        IaService_1.prototype.findNodeMatches = function (ref, nodes) {
            var _this = this;
        ...
        IaService_1.prototype.buildAmbiguityQuestion = function (step, nodes) {
            var laneRef = this.parseLaneReference(step);
        ...
        IaService_1.prototype.tryBuildAddEdgeFromNaturalLanguage = function (message, nodes) {
            var _this = this;
    ...
    _classThis.CONFIRM_WORDS = /\b(si|sí|dale|procesa|hazlo|aplicar|aplícalo|ejecuta)\b/i;
    _classThis.IMPROVEMENT_WORDS = /\b(mejorar|mejora|optimiza|optimizar|ayudame a mejorar|ayúdame a mejorar)\b/i;
    _classThis.INTERRUPT_WORDS = /\b(alto|espera|cancela|cancelar|deten|detener)\b/i;
    (function () {
